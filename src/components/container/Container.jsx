        ...
        <div>
            <div className={`container-fluid ${darkMode ? 'dark-mode' : ''}`}>
                ...
                <div className="button-group">
                    <button className={`btn ${activeFilter === 'All' ? 'active' : ''}`} onClick={() => handleButtonClick('All')}>All</button>
                    <button className={`btn ${activeFilter === 'General' ? 'active' : ''}`} onClick={() => handleButtonClick('General')}>General</button>
                    <button className={`btn ${activeFilter === 'Desktop' ? 'active' : ''}`} onClick={() => handleButtonClick('Desktop')}>Desktop</button>
                    <button className={`btn ${activeFilter === 'Web Browser' ? 'active' : ''}`} onClick={() => handleButtonClick('Web Browser')}>Web Browser</button>
                    <button className={`btn ${activeFilter === 'VS Code' ? 'active' : ''}`} onClick={() => handleButtonClick('VS Code')}>VS Code</button>
                    <button className={`btn ${activeFilter === 'Youtube' ? 'active' : ''}`} onClick={() => handleButtonClick('Youtube')}>Youtube</button>
                </div>
                ...
                {(activeFilter === 'All' || activeFilter === 'Desktop') && (
                    <>
                ...
                {(activeFilter === 'All' || activeFilter === 'Web Browser') && (
                    <>
                ...
                {(activeFilter === 'All' || activeFilter === 'VS Code') && (
                    <>
